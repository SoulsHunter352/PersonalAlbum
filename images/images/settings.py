...
SECRET_KEY = 'django-insecure-w5z@rzrc!l8kdppdk+t=3he)2ofi_xv_*b7ov%_m^&xlz7(lx+'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'users.context_processors.get_base_menu'
            ],
        },
    },
]
...
ASGI_APPLICATION = "images.asgi.application"
